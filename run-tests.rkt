...
(display "\e[0;34;42mr1-passes: tests passed!\e[0m") (newline)

(compiler-tests "integers and variables" #f r1-final "r1" (range 1 30))
(display "\e[0;34;42mr1-final: tests passed!\e[0m") (newline)
